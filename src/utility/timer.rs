...
pub fn check_ntp_time(mut ntp_adjustment: ResMut<NTPAdjustment>) {
    ...
    if ntp_adjustment.system_clock_error > 600000 || ntp_adjustment.system_clock_error < -600000 {
        panic!("System clock more than 10 minutes off from UTC")
    }
}
